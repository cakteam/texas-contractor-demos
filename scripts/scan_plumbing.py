...
targets = [
    ('Don the Plumber', 'https://dontheplumber.com/'),
    ('FB Plumbing', 'https://fbplumbingdfw.com/'),
    ('Flow Bros Plumbing', 'https://flowbrosplumbing.com/'),
    ('R&B Plumbing', 'https://rbplumbinginc.com/')
]
